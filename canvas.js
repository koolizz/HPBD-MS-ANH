(function () {
    ...
    function drawFlowers {
      var img = document.getElementById("birthday-cake-img");
      var x = getRandomInt(0, canvas.width - img.width);
      var y = getRandomInt(0, canvas.height - img.height);
      ctx.drawFlower(img, x, y);
      scaleCanvas()
      //background color   
